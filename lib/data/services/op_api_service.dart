...
class OpApiService {
  ...
  static const String _webProxyUrl = '/api/optcg-cards?catalog=v12';
  static const String _assetCachePath = 'assets/one_piece_cards_cache.json';
  static const String _cachedCardsKey = 'all_cards_v9';
  static const String _cachedAtKey = 'all_cards_v9_cached_at';
  static const List<String> _legacyCacheKeys = <String>[
    'all_cards_v5',
    'all_cards_v6',
    'all_cards_v6_cached_at',
    'all_cards_v7',
    'all_cards_v7_cached_at',
    'all_cards_v8',
    'all_cards_v8_cached_at',
    'all_cards_cached_at',
  ];
